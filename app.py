...
cherrypy_conf = {
    ...
    '/static': {
        ...
        'tools.staticdir.dir': 'C:/Users/Priestli/OneDrive/Pictures//drone/template'
    }
}
...
class Drone(object):
    def __init__(self, server_enabled=True):
        ...
        self._log("Dronepolice operation Start")
...
class Templates:
    def __init__(self, home_coords):
        ...
        self.environment = Environment(loader=FileSystemLoader(local_path + '/templates'))
